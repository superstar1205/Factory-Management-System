            ...
            <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Items</h4>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="metatitle">Item Name</label>
                                                        <input name="itemName" id="itemName" type="text" class="form-control" placeholder="Enter Item Name" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="search-box mr-2 mb-2 d-inline-block">
                                                    <?php echo form_open('', array('method' => 'post'));?>
                                                        <div class="position-relative">
                                                            <input type="text" name="srch_txt" class="form-control" value="<?php echo $srch_txt;?>" placeholder="Search by Item Name">
                                                ...
                                                <table class="table table-centered table-nowrap">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="width: 70%;">Item Name</th>
                ...
                <script>
                    ...
                    function edit_func(edit_id){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('items/get_info');?>", 
                            data: { "edit_id": edit_id } 
                        }).done(function( msg ) { 
                            var json_obj = jQuery.parseJSON(msg); 
                            
                            $("#itemName").val(json_obj.itemName);
                            $("#new_pan").slideDown();
                        });
                    }
